...
class single_HMunit {
 public:
  ...
  void set_data_lai(const hdata& _lai_dta);//!< Setter data on HB of single pdm unit
  ...
  void load_data_PTLAI(const hdata& prec_input, const hdata& temp_input, const hdata& lai_input,const numberSel& val,const unsigned& inYear, const unsigned& inMonth,const unsigned& inDay);
